...
//----------------Hier kommt alles, dass die Playlistst auf localstorage gespeichert werden--------------------
...
// Funktion zum Laden der Playlists aus dem Local Storage
function loadPlaylists() {
...
// Funktion zum Anzeigen der Playlists (existiert bereits, eventuell anpassen)
function displayPlaylists() {
    playlistContainer.innerHTML = '';
    playlists.forEach((playlist, index) => {
        // Ihr bestehender Code zum Anzeigen der Playlists
    });
}

// Neue Playlist erstellen (anpassen)
document.getElementById('addPlaylistBtn').addEventListener('click', () => {
